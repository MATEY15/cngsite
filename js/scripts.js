...
$('.home-slider').slick({
    ...
    prevArrow: '<div class="slider-home--prev"><img src="../wp-content/themes/cng/img/arrow.svg" /></div>',
    nextArrow: '<div class="slider-home--next"><img src="../wp-content/themes/cng/img/arrow.svg" /></div>',
    responsive: [{
            breakpoint: 992,
            settings: {
                slidesToShow: 2,
...
$(".animate-item, .section-animate p").each(function() {
